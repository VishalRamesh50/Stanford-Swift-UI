...
struct MemoryGame<CardContent> where CardContent: Equatable {
    ...
    private var previouslySeenCardIDs: Set<Int> = Set<Int>()
        ...
        if let chosenIndex = cards.firstIndex(matching: card), !cards[chosenIndex].isFaceUp, !cards[chosenIndex].isMatched {
            if let potentialMatchIndex = indexOfTheOneAndOnlyFaceUpCard {
                if cards[chosenIndex].content == cards[potentialMatchIndex].content {
                    ...
                    previouslySeenCardIDs.insert(cards[potentialMatchIndex].id)
                }
    ...
    struct Card: Identifiable {
        ...
        // MARK: - Bonus Time
        // this could give matching bonus points if the user matched the card
        ...
        // (i.e. not including the current time it's been face up if currently so)
